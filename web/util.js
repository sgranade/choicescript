...
function restoreGame(state, forcedScene, userRestored) {
    ...
    if (!isStateValid(state)) {
        ...
        scene = new Scene(startupScene, _global.stats, _global.nav, {debugMode:_global.debug, secondaryMode:secondaryMode, saveSlot:saveSlot, transcriptMode:_global.transcriptMode});
    } else {
      ...
      scene = new Scene(state.stats.sceneName, state.stats, _global.nav, {debugMode:state.debug || _global.debug, secondaryMode:secondaryMode, saveSlot:saveSlot, transcriptMode:_global.transcriptMode});
      if (!forcedScene) {
